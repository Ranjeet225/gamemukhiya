            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        @if (isset($withdrawal) && $withdrawal->payment_method == 'upi')
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('UPI ID')
                                <span class="fw-bold">{{ $withdrawal->upi_id }}</span>
                            </li>
                        @elseif(isset($withdrawal) && $withdrawal->payment_method == 'bank')
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Account Holder Name')
                                <span class="fw-bold">{{ $withdrawal->account_holder_name }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Account Number')
                                <span class="fw-bold">{{ $withdrawal->account_number }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('IFSC Code')
                                <span class="fw-bold">{{ $withdrawal->ifsc_code }}</span>
                            </li>
                        @endif
