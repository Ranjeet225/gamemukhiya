                                ...
                                <div class="card-body p-0">
                                    <div class="payment-system-list p-3">
                                        ...
                                        <div class="payment-method-wrapper">
                                            <br>
                                            <div class="payment-method__title">@lang('Select Payment Method')</div>
                                            <div class="form-group">
                                                <select name="payment_method" class="form-control form--control"  required>
                                                    <option value="" style="color:black !important" {{ old('payment_method') == '' ? 'selected' : '' }}>@lang('Select One')</option>
                                                    <option value="bank" style="color:black !important" {{ old('payment_method') == 'bank' ? 'selected' : '' }}>@lang('Bank')</option>
                                                    <option value="upi" style="color:black !important" {{ old('payment_method') == 'upi' ? 'selected' : '' }}>@lang('UPI')</option>
                                                </select>
                                            </div>
                                            <div class="bank-details d-none">
                                                <div class="form-group">
                                                    <label>@lang('Account Holder Name')</label>
                                                    <input type="text" name="account_holder_name" class="form-control form--control" placeholder="@lang('Enter Account Holder Name')" value="{{ old('account_holder_name') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>@lang('Account Number')</label>
                                                    <input type="text" name="account_number" class="form-control form--control" placeholder="@lang('Enter Account Number')" value="{{ old('account_number') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>@lang('IFSC Code')</label>
                                                    <input type="text" name="ifsc_code" class="form-control form--control" placeholder="@lang('Enter IFSC Code')" value="{{ old('ifsc_code') }}">
                                                </div>
                                            </div>
                                            <div class="upi-details d-none">
                                                <div class="form-group">
                                                    <label>@lang('UPI ID')</label>
                                                    <input type="text" name="upi_id" class="form-control form--control" placeholder="@lang('Enter UPI ID')" value="{{ old('upi_id') }}" >
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn--base w-100 mt-3" disabled>@lang('Confirm Withdraw')</button>
...
@push('script')
    ...
    <script>
        $('select[name=payment_method]').on('change', function() {
            ...
            $('.bank-details, .upi-details').addClass('d-none');
